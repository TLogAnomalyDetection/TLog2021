...
class TLogRunner:
    ...
    def run_optimizer(self, train_dataloader, test_dataloader, log_payload, labels_test):
        ...
        self.optimizer = torch.optim.Adam(filter(lambda p: p.requires_grad, self.model.parameters()), lr=0.00001,
...
#             self.max_distances.append(max_distances)
    ...
    def tokenize_data(self, log_payload, labels):
        ...
        self.model = TLog(src_vocab=self.src_vocab, **self.model_params,
